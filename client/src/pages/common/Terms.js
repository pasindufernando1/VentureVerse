        ...
        <div className="flex flex-col justify-between items-center w-full overflow-hidden px-32 m-24">
            ...
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                ...
                <AccordionBody>
                    ...
                    <p className="text-justify">
                        <p>By submitting your application, you acknowledge and agree that your submission is solely for the purpose of being considered by Venture Verse for participation on Venture Verse.</p>
                        <p>You understand that you will not receive any compensation or credit for making the submission.</p>
                        <p>If the applicant is a minor, you affirm that you are the parent or legal guardian of the minor, authorized to apply on their behalf, and you are submitting and signing the application on their behalf.</p>
                        <p>By making a submission, you are accepting and agreeing to the Venture Verse Terms of Use.</p>
                        <p>You acknowledge that your email submission is not confidential and is not submitted in confidence or trust.</p>
                        <p>No confidential or fiduciary relationship is intended or created by making an email submission.</p>
                        <p>By making a submission, you hereby release Venture Verse and its administrators, directors, officers, shareholders, employees, licensees, assigns, and successors from any and all claims related to your email submission.</p>
                        <p>This includes, but is not limited to, any claims arising from the risk of misdirection or misdelivery of your email.</p>
                    </p>
                </AccordionBody>
            </Accordion>
            ...
            <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                ...
                <AccordionBody>
                    <p className="text-justify">
                        <p>I hereby represent and warrant that:</p>
                        <p>(i) I, alone or in concert with any collaborators listed below (collectively "Collaborators"), have the right to grant the rights granted hereunder,</p>
                        <p>(ii) I alone or in concert with any Collaborators, have the right to enter into this Agreement;</p>
                        <p>(iii) I, alone or in concert with any Collaborators, own and control all rights in and to the idea, product, invention, service, or business that I desire to present as part of my participation in the Series;</p>
                        <p>(iv) the consent of no other person, firm, corporation, or labor organization (other than any Collaborators) is required to make my desired presentation or to enable Venture Verse entity to use the Likeness, Business Indicia, Statements, and the Material as described herein;</p>
                        <p>(v) Producer's use of the Material, Business Indicia, Statements, and Likeness hereunder will not violate the rights of any third party other than any Collaborators;</p>
                        <p>(vi) Producer shall have the right to use the Material free and clear of any claims for royalties, residuals, or other compensation, either by virtue of this Agreement or any guild or union agreement, which I acknowledge does not govern my relationship with Producer;</p>
                        <p>(vii) I have answered all questionnaire and application questions completely, honestly, and accurately, and I acknowledge that if any of the foregoing information is found to be false, that this will be grounds for my dismissal from the registration process and/or from the platform, if selected;</p>
                        <p>(viii) I further understand and acknowledge that I will be required to enter into further agreements with Venture Verse entity relating to my Business and enrollment in the platform; and</p>
                        <p>(ix) I understand and agree that all decisions by the Producer concerning the selection of the participants are final and not subject to challenge or appeal.</p>
                    </p>
                </AccordionBody>
            </Accordion>
            <Accordion open={open === 4} icon={<Icon id={4} open={open} />}>
                ...
                <AccordionBody>
                    <p className="text-justify">
                        <p>I understand that the announcement, solicitation and/or acceptance of any investment in my Business or any equity interests thereto of any kind from one or more of the Investors or any other person may be a securities offering and/or a sale of securities governed by federal, state, and other securities laws, and I agree to comply with any and all applicable securities laws in connection therewith, including but not limited to laws governing the offer and sale of securities.</p>
                        <p>I also understand that it is my sole responsibility to comply with such securities laws, that Venture Verse entity will not be providing me with any advice or assistance of counsel in that regard.</p>
                        <p>In addition, I acknowledge and agree that Venture Verse entity will not be acting on my behalf, either directly or indirectly, as an agent, broker, or finder, in connection with the offer or sale of any securities and that the Venture Verse entity will not have any liability for my failure to comply with such securities laws.</p>
                        <p>Confidentiality. Without the express prior written consent of Venture Verse entity, I shall not at any time, reveal, report, publish, or disclose any information or trade secrets obtained or learned by me about the platform, including, without limitation, any information concerning or relating to the platform, the participants, the events contained in the platform, any ideas, products, inventions, services, or businesses presented by any user in connection with the platform or the outcome of the platform or any presentation associated therewith (collectively, "Confidential Information").</p>
                        <p>This confidentiality obligation shall remain in place whether or not I am enrolled in the platform, and shall continue both during and after my enrollment in the registration and, if I am selected as a user, my participation in the Series, and shall continue regardless of whether or not it includes some or all of the Confidential Information.</p>
                        <p>I further agree that any Confidential Information of which I become aware will only be used for the express and exclusive purposes for which Venture Verse entity has instructed me to use the Confidential Information.</p>
                    </p>
                </AccordionBody>
            </Accordion>
            ...
            <Accordion open={open === 6} icon={<Icon id={6} open={open} />}>
                ...
                <AccordionBody>
                    <p className="text-justify">
                        <p>I acknowledge that there is a possibility that after my execution of this Agreement, I may discover facts or incur or suffer claims which were unknown or unsuspected at the time this Agreement was executed and which, if known by me at that time, may have materially affected my decision to execute this Agreement.</p>
                        <p>I acknowledge and agree that by reason of this Agreement, and the release of liability contained herein, I am assuming any risk of such unknown facts and such unknown and unsuspected claims.</p>
                        <p>I have been advised of the existence of Section 1542 of the California Civil Code which provides:</p>
                        <p><em>A GENERAL RELEASE DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR DOES NOT KNOW OR SUSPECT TO EXIST IN HIS OR HER FAVOR AT THE TIME OF EXECUTING THE RELEASE WHICH, IF KNOWN BY HIM OR HER, MUST HAVE MATERIALLY AFFECTED HIS OR HER SETTLEMENT WITH THE DEBTOR.</em></p>
                    </p>
                </AccordionBody>
            </Accordion>
            <Accordion open={open === 7} icon={<Icon id={7} open={open} />}>
                ...
                <AccordionBody>
                    <p className="text-justify">
                        <p>Individually and on behalf of the Releasing Parties, I agree to defend (at indemnitees' option), indemnify, and hold harmless the Releases from any and all Claims caused by or arising out of my application for and/or participation in and in connection with the VentureVerse platform, including, without limitation, any of the following:</p>
                        <p>(1) any statement, action, or omission made or taken by me or anyone else during or in connection with or relating to the platform;</p>
                        <p>(2) my failure to follow the instructions of the VentureVerse entity, Network, any of their officers, agents, representatives, or employees, or anyone connected with the platform;</p>
                        <p>(3) my breach of any of my representations, warranties, undertakings, promises, or obligations pursuant to this Agreement or the platform Rules (as may be promulgated and amended from time to time);</p>
                        <p>(4) my possession or use of any prize or investment; or</p>
                        <p>(5) the use by Producer or Network or any of their respective licensees or assigns of any of the rights I have granted herein.</p>
                    </p>
                </AccordionBody>
            </Accordion>
            ...
            <Accordion open={open === 9} icon={<Icon id={9} open={open} />}>
                ...
                <AccordionBody>
                    <p className="text-justify">
                        ...
                        <p>The Federal Arbitration Act (9 U.S.C. § 1, et seq.) or its successor statute shall apply and govern the enforcement of this arbitration clause. By agreeing to arbitration, the parties acknowledge that they have waived the right to a jury trial.</p>
                        <p>The parties further acknowledge and agree that the business realities of television productions of this nature, including the Series, create special circumstances for which Producer must be able to maintain its ability to seek injunctive relief and/or other equitable and/or provisional remedies.</p>
                        <p>Accordingly, the parties agree that nothing in this paragraph or in any of the applicable rules of JAMS shall prevent Producer, SPT, or Network from seeking provisional relief outside of arbitration.</p>
                        <p>For example, a participant's premature or threatened disclosure in violation of the confidentiality provisions of this Agreement could result in a reduction of audience interest or other diminution in the value of the Series or Producer's, SPT's, or Network's rights hereunder, which would cause Producer, SPT, and Network irreparable injury and damage that could not be reasonably calculated or adequately compensated by damages in an action at law.</p>
                        <p>I hereby expressly agree that Producer, SPT, and Network shall be entitled to injunctive and other equitable relief pursuant to California Code of Procedure section 1281.8 and any successor or similar statute.</p>
                        <p>2. Severability, Assignment. Without limiting the foregoing, any provision of this Agreement that is invalid, illegal, or unenforceable in any jurisdiction will, as to that jurisdiction, be ineffective only to the extent of such invalidity, illegality, or unenforceability, without affecting in any way the remaining provisions hereof in such jurisdiction or rendering that or any other provision of this Agreement invalid, illegal, or unenforceable in any other jurisdiction.</p>
                        <p>Producer (and its assignees and licensees) may freely assign, in whole or in part, any of their rights or obligations under this Agreement. I may not assign any of my rights or obligations under this Agreement.</p>
                    </p>
                </AccordionBody>
            </Accordion>
            ...
            <Accordion open={open === 15} icon={<Icon id={15} open={open} />}>
                ...
                <AccordionBody>
                    <p className="text-justify">
                        ...
                        <p>As between the undersigned and the Platform, the Platform shall solely own all rights in and to the Platform, including without limitation the copyright in the Platform and any advertising or promotional materials for the Platform. The Platform shall have all rights to use the Platform, including without limitation images and/or footage including or incorporating the IP, in any and all manners and media, whether now known or hereinafter devised, throughout the universe in perpetuity, in any and all languages. The undersigned also consents to the use of the IP in connection with the advertising, promotion, marketing, and exploitation of the Platform.</p>
                        <p>The undersigned hereby waives any right that the undersigned may have to inspect or approve the finished Series or any advertising, marketing or promotional materials that may be used in connection therewith. In no event shall the undersigned have the right to terminate the rights granted to VentureVerse hereunder or to enjoin, restrain, or otherwise interfere with the development, production, distribution or other exploitation of the Series.</p>
                        <p>The undersigned hereby represents and warrants that: (i) it is the owner and/or authorized representative of the IP and that it has the full authority to execute this release and to grant Producer the permission and rights herein granted, and that no one else's permission or consent is required, and (ii) that no credit, acknowledgment, payment, contribution, monies and/or any other consideration is required to the undersigned and or any other person and/or entity (including but not limited to any guild, union and/or other collective bargaining organization) for Producer's use of the IP as provided in this agreement.</p>
                        <p>The undersigned, and its representatives, successors and assigns hereby absolutely, unconditionally and forever release and discharge Producer and all other persons and entities connected with the Series, and each of them from any and all claims, actions, causes of action, proceedings, suits, awards, judgments, damages, liabilities, losses, costs and expenses of any kind (including, without limitation, reasonable attorneys' fees and union fees, if any) arising out of, resulting from, or by reason of, the use of the IP in or in connection with the Series (including without limitation, claims based on patent, trademark or copyright infringement, rights of publicity or privacy, defamation or false negative light).</p>
                        <p>The undersigned shall defend (at indemnitee's option), indemnify and hold harmless Producer, Sony Pictures Television Inc., American Broadcasting Companies, Inc., each of their respective parents, subsidiary, affiliated and related entities and their respective officers, directors, employees, shareholders, contractors, members, representatives, agents, licensees, successors and assigns of each of the foregoing, from all liability, injury, damage, expense, or loss caused by or arising out of or related to (1) any act or omission of the undersigned which is a breach of the provisions of this Intellectual Property Release: (1) a breach of any of the undersigned's representations and warranties or agreements hereunder, (ii) materials or images appearing in the Series that were provided to Producer by the undersigned (including, but not limited to, any logos and trademarks), and (iv) the negligence or willful misconduct of the undersigned or the undersigned's agents, employees, contractors or representatives.</p>
                        <p>The undersigned acknowledges that in no event shall Producer be obligated to use the IP in the Series or otherwise or to exercise any other rights, licenses or privileges granted to Producer hereunder.</p>
                        <p>This Intellectual Property Release shall be binding upon the undersigned and the undersigned's heirs, representatives, agents, employees, contractors, successors, licensees and assigns.</p>
