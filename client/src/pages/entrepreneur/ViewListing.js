...
import {CommonNavbar} from "../webcomponent";
    ...
    return (
        <div>
            <div className="h-auto min-h-[100vh] p-[2rem] flex justify-center items-center">
                ...
                <div hidden={fullView}>
                <div className="bg-white flex drop-shadow-md mb-4 w-full h-full  rounded-[1rem] lg:w-9/12 lg:h-auto">
                <div>
                <Card className="mt-6 w-[40rem]">
                    ...
                    <CardBody>
                        ...
                        <div className="flex justify-between items-center mt-5">
                            <Typography variant="h6" color="blue-gray" className="mb-2 text-main-gray font-bold">
                        ...
                        <div className="row mt-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: '10px' }}>
                            <div>
                                <Typography variant="h6" color="blue-gray" className="mb-2 text-main-gray font-bold">
                                <span>Business start date : </span><span className="font-light">2022-01-01</span>
                                </Typography>
                            </div>
                            <div>
                                <Typography variant="h6" color="blue-gray" className="mb-2 text-main-gray font-bold">
                        ...
                        <div className="row mt-[-8px]">
                            <div>
                                <Typography variant="h6" color="blue-gray" className="mb-2 text-main-gray font-bold">
                                <span>Lifetime sales :      </span><span className="font-light">Rs. 5000000</span>
                                </Typography>
                            </div>
                        </div>
                        <div className="row mt-[-8px]">
                    ...
                    <CardFooter className="pt-0 flex justify-center">
                        ...
                        <CustomButton 
                            ...
                            onClick={onClickfull}
                        >
                            <a href="/entrepreneur/view-listingCounterProposal" className="text-white">View offerings</a>
                        </CustomButton>
                    </CardFooter>
                </Card>
                </div>
