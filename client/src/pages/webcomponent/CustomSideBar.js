...
const CustomSideBar = (props) => {
    ...
    return (
        <div className="flex flex-row h-[100vh]">
            <Card
                className={`transition-all duration-500 flex items-center h-full max-h-full lg:!w-full lg:!max-w-[20rem] ${ openNav? "!w-full" : "!w-[5rem]"} p-4 shadow-xl shadow-blue-gray-900/5 rounded-none border-r-[1px]`}>
                <div className={`mb-2 flex items-center ${ openNav? "!justify-between" : "!justify-center"} w-full lg:!justify-start h-[66.84px] lg:h-auto`}>
                    <img src="/assets/images/VentureVerse-Black.png" className={`lg:!w-[10rem] h-auto ${ openNav? "w-[10rem]" : "!w-0"}`} alt="Logo"/>
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="m-[4rem] h-auto w-auto">
                    {children}
                </div>
            </div>
        </div>
